...
private:
    void discoverFingerprints(string user,FingerprintDevice *device);
    void addFingerprintData(FingerprintData *fpd);

public:
    FingerprintDiscoverer(FingerprintDevice *devices);
    FingerprintDiscoverer(FingerprintDevice *devices, string user);
